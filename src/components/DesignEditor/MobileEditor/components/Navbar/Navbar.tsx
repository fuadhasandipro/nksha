...
import { loadTemplateFonts } from "@/components/DesignEditor/utils/fonts"
import { loadVideoEditorAssets } from "@/components/DesignEditor/utils/video"
            ...
            onClick={async () => {
              ...
              if (currentDesign) {
                ...
                const { data: existingSession, error: sessionError } = await supabase
                  .from('user_designs')
                  .select('id')
                  .eq('session', router.query.session).single()
                ...
                if (sessionError) {
                  const { error: insertError } = await supabase
                    ...
                    .insert({
                      ...
                      thumbnail: "https://marketplace.canva.com/EAF2HYhH51c/2/0/800w/canva-4B2qPkf31Iw.jpg",
