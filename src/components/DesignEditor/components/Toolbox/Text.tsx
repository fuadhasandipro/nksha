...
import TextColor from '@/components/DesignEditor/components/Icons/TextColor';
import Bold from '@/components/DesignEditor/components/Icons/Bold';
import Italic from '@/components/DesignEditor/components/Icons/Italic';
import Underline from '@/components/DesignEditor/components/Icons/Underline';
import TextAlignCenter from '@/components/DesignEditor/components/Icons/TextAlignCenter';

import { Button, SIZE, KIND } from 'baseui/button';
import { StatefulTooltip, PLACEMENT } from 'baseui/tooltip';
import LetterCase from '@/components/DesignEditor/components/Icons/LetterCase';
import Spacing from '@/components/DesignEditor/components/Icons/Spacing';
import { StatefulPopover } from 'baseui/popover';
import TextAlignJustify from '@/components/DesignEditor/components/Icons/TextAlignJustify';
import TextAlignLeft from '@/components/DesignEditor/components/Icons/TextAlignLeft';
import TextAlignRight from '@/components/DesignEditor/components/Icons/TextAlignRight';
